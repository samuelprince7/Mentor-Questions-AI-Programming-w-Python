...
rebuilt_detailed_model = simple_load_rebuilt_model(detailed_checkpoint)
...
probs, classes = predict1(data_dir, rebuilt_model, utilize_gpu, top_probs)
print(probs)
print(classes)
...
sp_sanity_checker(flower_names, data_dir, rebuilt_model, rebuilt_detailed_model)
#789
