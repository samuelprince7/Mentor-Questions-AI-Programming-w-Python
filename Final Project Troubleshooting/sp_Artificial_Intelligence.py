...
def train_the_model(model, training_dataloaders, val_dataloaders, learn_rate, epochs): 
    ...
    #this will ahve already been printed out to the command land user in train.py
    #but we want to make sure we have access to the device inside the function as well
...
#this step (2 lines below) may be unnecessary bc it is in the main predict.py program itself. let's try running without it
...
# last update   at 6:10pm   march 5, 2021        
